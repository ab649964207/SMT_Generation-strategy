...
from 可修改代码smt.generator import NormalGenerator
...
if __name__ == '__main__':
    ...
    # 1.2 Subtraction
    pwd = "pddl/1.Sub/1.2 Subtraction/Subtraction-(3,6,7).pddl"
    ...
    #
    # pwd ="pddl/2.Nim/2.5 Empty and Redistribute/Empty-and-Redistribute(n=3)v3le2.pddl"
    # domain = PDDLParser("pddl/2.Nim/2.5 Empty and Redistribute/Empty-and-Redistribute(n=3)v3le2.pddl")
    ...
    gen = NormalGenerator(domain,pwd)  #generator ,求解，得到结果
